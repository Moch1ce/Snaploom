...
> 当前仓库正在按 [Spec #34](https://github.com/moch1ce/Snaploom/issues/34) 从 .NET/Avalonia 迁移到 Tauri 2、Rust 与 TypeScript/Canvas。迁移前的最后可运行实现冻结于 `dotnet-final`；完成冻结前，本节中的 .NET 命令仍是当前树的开发入口。
